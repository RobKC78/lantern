...
## Download and install — v0.1.0 test builds

| System | Download | Instructions | Validation |
| --- | --- | --- | --- |
| Windows 64-bit | [Windows Setup.exe](https://github.com/RobKC78/lantern/raw/refs/heads/main/downloads/Lantern-Setup-0.1.0.exe) | [Windows installation](docs/INSTALL-WINDOWS.md) | Packaged app startup and diagnostics tested; installer lifecycle untested |
| Ubuntu / Debian / Linux Mint | [Debian package](https://github.com/RobKC78/lantern/raw/refs/heads/main/downloads/Lantern-0.1.0_all.deb) | [Debian installation](docs/INSTALL-DEBIAN.md) | Package structure checked; Linux installation/runtime untested |
| CachyOS / compatible Arch systems | [CachyOS package](https://github.com/RobKC78/lantern/raw/refs/heads/main/downloads/lantern-diagnostics-0.1.0-1-any.pkg.tar.gz) | [CachyOS installation](docs/INSTALL-CACHYOS.md) | Package structure checked; pacman installation/runtime untested |
...
- Offers **Fix this**, **Fix selected**, and **Fix all my stuff** for supported service-start repairs only. Each batch requires plan approval, elevation, a verified service-state backup and result checks.
